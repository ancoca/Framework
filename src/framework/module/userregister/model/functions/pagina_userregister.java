...
public class pagina_userregister {
    ...
    public static void inicializa() {
        int rowCount = 0;
        rowCount = ((miniSimpleTableModel_userregister)List_userregister.TABLA.getModel()).getRowCount();
        
        int v = rowCount%itemsPerPage==0 ? 0 : 1;
        maxPageIndex = rowCount/itemsPerPage + v;
        
        box.setBorder(BorderFactory.createEmptyBorder(2,2,2,2));
        List_userregister.jPanel4.setLayout(new BorderLayout());
        List_userregister.jPanel4.add(pagina_userregister.box);  
    }
    ...
    public static void initLinkBox() {
        ...
        if(  (rowCount<=itemsPerPage) && (rowCount>0)  ){ //caben todos los datos en la misma página
            ...
            List_userregister.primero.setEnabled(false);
            List_userregister.ANTERIOR.setEnabled(false);
            List_userregister.SIGUIENTE.setEnabled(false);
            List_userregister.ultimo.setEnabled(false);
            List_userregister.CAJA.setText("");
            ...
            List_userregister.primero.setEnabled(currentPageIndex>1);
            List_userregister.ANTERIOR.setEnabled(currentPageIndex>1);
            List_userregister.SIGUIENTE.setEnabled(currentPageIndex<maxPageIndex);
            List_userregister.ultimo.setEnabled(currentPageIndex<maxPageIndex);
            List_userregister.CAJA.setText(Integer.toString(currentPageIndex) + String.format(" / %d", maxPageIndex));
