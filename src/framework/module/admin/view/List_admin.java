...
public class List_admin extends javax.swing.JFrame {
	...
	//this.setIconImage(icono);
        ...
        pagina_admin.itemsPerPage=Integer.parseInt(jComboBox2.getSelectedItem().toString());
        pagina_admin.currentPageIndex = 1;
        pagina_admin.initLinkBox();
        
        jLabel3.setText(String.valueOf(Singleton_admin.useradmin.size()));
        ...
        for(int i=0;i<=Singleton_admin.useradmin.size()-1;i++) {
            myWords.add(Singleton_admin.useradmin.get(i).getName());
        }
    ...
    private void initComponents() {
        ...
        jPanel2.add(ANTERIOR, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));
        ...
        jPanel2.add(SIGUIENTE, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 10, -1, -1));

        CAJA.setEditable(false);
        CAJA.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        CAJA.setPreferredSize(new java.awt.Dimension(140, 20));
        jPanel2.add(CAJA, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 80, 30));
        ...
        jPanel2.add(primero, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        jPanel2.add(ultimo, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, -1, -1));
