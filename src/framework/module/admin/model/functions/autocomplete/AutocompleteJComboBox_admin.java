...
public class AutocompleteJComboBox_admin extends JComboBox{
    private final Searchable_admin<String,String> searchable;

    public AutocompleteJComboBox_admin(Searchable_admin<String,String> s){
	super();
	this.searchable = s;
